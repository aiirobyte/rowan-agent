...
`docs/PLAN/` is retained as the legacy release-planning tree for historical plans and roadmap context. New or resumed version work should use `docs/version/<semver>/`.
